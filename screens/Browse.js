...
import { StyleSheet, ImageBackground, Text, View, TextInput, Image, Button, ScrollView, TouchableOpacity, AsyncStorage } from 'react-native';
   ...
   <View style={{margin: 25}}>
     ...
     <Card style={{height: 135, marginBottom: 5}}>
       ...
       <View style={[styles.view, {width: '100%'}]} >
          ...
          <TouchableOpacity onPress={this.payWithRave} >
