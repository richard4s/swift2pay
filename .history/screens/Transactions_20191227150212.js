...
export default class Transactions extends Component {
  static navigationOptions = {
   ...
   getTransactions = async () => {
    ...
    fetch('https://swift2pay.com/account/api/request.php?action=getTransactions&userID=1&apiKey=JFJHFJJ38388739949HFGDJ'+grabUserId+'&apiKey=JFJHFJJ38388739949HFGDJ', {
      method: 'GET',
    }) 
