...
import { StyleSheet, ImageBackground, Text, View, Image, Button, TouchableOpacity, Linking } from 'react-native';
  ...
  render() {
    ...
    return (
      ...
      <View style={styles.screen}>
        ...
        <Button  color="#932BAD" title='Login' onPress={() => navigate.require('./Login')}  />
        <Text style={styles.login} onPress={() => navigate.require('./Login')} > Login </Text>
