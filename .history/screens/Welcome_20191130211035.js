  ...
  render() {
    ...
    return (
      ...
      <View style={styles.screen}>
        ...
        <Button onPress={() =>navigation.navigate('Login')}><Text button style={styles.login} >Login</Text></Button>
        <Text style={styles.signup} onPress={() =>navigation.navigate('Login')} >SignUp</Text>
