     ...
     <Card style={{height: '30%'}}>
       ...
       <View style={styles.view}>
          <Card style={styles.cardTwo}>
            ...
            <Text style={{fontSize: 8, fontWeight: 'bold', textAlign: "center", padding: 5, }} >Scan QR</Text>
          </Card>
          <Card style={styles.cardTwo}>
            <Image source={require('../assets/images/browse-icons/transaction.png')} style={styles.imageTwo} />
            <Text style={{fontSize: 8, fontWeight: 'bold', textAlign: "center", padding: 5, }} >Transactions</Text>
          </Card>
          <Card style={styles.cardTwo}>
            <Image source={require('../assets/images/browse-icons/transfer.png')} style={styles.imageTwo} />
            <Text style={{fontSize: 8, fontWeight: 'bold', textAlign: "center", padding: 5, }} >Transfer</Text>
          </Card>
          <Card style={styles.cardTwo}>
            <Image source={require('../assets/images/browse-icons/wallet.png')} style={styles.imageTwo} />
            <Text style={{fontSize: 8, fontWeight: 'bold', textAlign: "center", padding: 5, }} >Fund Wallet</Text>
          </Card>
       </View>
     </Card>
   </View>
