  ...
  render() {
    ...
    return (
      ...
      <View style={styles.screen}>
        ...
        <Button  color="#932BAD" title='Login' onPress={this.gotoLogin}  />
        <TouchableOpacity onPress={this.gotoLogin} ><Text style={styles.login} onPress={this.gotoLogin} > Login </Text></TouchableOpacity>
