  ...
  render() {
    ...
    return (
      ...
      <View style={styles.screen}>
        ...
        <TouchableHighlight  color="#932BAD" style={styles.signup} title='Login' onPress={() =>navigate('Login')}></TouchableHighlight> 
        <TouchableHighlight color="#932BAD" title='SignUp' style={styles.signup}></TouchableHighlight>
