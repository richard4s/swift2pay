 ...
 render() {
  ...
  return (
   ...
   <View style={{margin: 25}}>
     <Card>
       <Text>Wallet Balance: NGN595,000</Text>
       <View>
        <Card style={styles.card}>
          <View>
            <Image source={require('../assets/images/browse-icons/scan-qr.png')} />
            <Text>Scan QR</Text>
          </View>
        </Card>
        <Card>
          <View>
            <Image source={require('../assets/images/browse-icons/transaction.png')} />
            <Text>Transactions</Text>
          </View>
        </Card>
        <Card>
          <View>
            <Image source={require('../assets/images/browse-icons/transfer.png')} />
            <Text>Transfer</Text>
          </View>
        </Card>
        <Card>
          <View>
            <Image source={require('../assets/images/browse-icons/wallet.png')} />
