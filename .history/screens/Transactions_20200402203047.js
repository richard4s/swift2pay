   ...
   renderRow = ({item}) => {
      return (
        <View style={styles.itemRow}>
          <Card>
            <Text style={styles.itemText}>Service Name: {item.service_name}</Text>
            {item.service_value ? <Text style={styles.itemText}>Service Value: {item.service_value}</Text> : <Text style={styles.itemText}>NULL</Text>}
            <Text style={styles.itemText}>Service Value: {item.service_value}</Text>
            <Text style={styles.itemText}>Amount: {item.amount}</Text>
            <Text style={styles.itemText}>Date: {item.date}</Text>
            <Text style={styles.itemText}>Value Number: {item.value_number}</Text>
          </Card>
        </View>
      )
   }
