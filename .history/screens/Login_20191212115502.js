...
const userInfo = fetch(`https://swift2pay.com/account/api/request.php?action=login&email=${this.state.email}&password=${this.state.password}&apiKey=JFJHFJJ38388739949HFGDJ`)
