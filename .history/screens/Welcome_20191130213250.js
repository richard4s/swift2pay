  ...
  render() {
    ...
    return (
      ...
      <View style={styles.screen}>
        ...
        <Button  color="#932BAD" style={{padding: 5, margin: 25}} title='Login' onPress={() => navigation.navigate('Login')}  />
        <Text button style={styles.login} onPress={() => navigation.navigate('Login')} >Login</Text>
