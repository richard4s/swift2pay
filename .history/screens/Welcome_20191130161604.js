...
import { StyleSheet, ImageBackground, Text, View, Image, TouchableHighlight, Button } from 'react-native';
  ...
  render() {
    ...
    return (
      ...
      <View style={styles.screen}>
        ...
        <TouchableHighlight >
        <Button title='Login' onPress={() =>navigate('Login')} style={styles.login} />
        </TouchableHighlight>
        <TouchableHighlight>
        <Button title='SignUp' style={styles.signup} />
        </TouchableHighlight>
