...
import { StyleSheet, ImageBackground, Text, View, Image, Button, Touc } from 'react-native';
  ...
  render() {
    ...
    return (
      ...
      <View style={styles.screen}>
        ...
        <Button  color="#932BAD" style={styles.signup} title='Login' onPress={() =>navigate('Login')}  />
