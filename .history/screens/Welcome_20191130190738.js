  ...
  render() {
    ...
    return (
      ...
      <View style={styles.screen}>
        ...
        <TouchableOpacity  color="#932BAD" style={styles.signup} title='Login' onPress={() =>navigate('Login')} />
        <TouchableOpacity color="#932BAD" title='SignUp' style={styles.signup} <Text></Text> />
