       ...
       <View style={[styles.view, {width: '100%'}]} >
          ...
          <TouchableOpacity onPress={() => navigate('FundWallet') } >
            <Card style={styles.cardTwo}>
              ...
              <Text style={{fontSize: 8, fontWeight: 'bold', textAlign: "center", padding: 2, margin: 5,}} >Fund Wallet</Text>
            </Card>
          </TouchableOpacity>
          ...
          <TouchableOpacity>
            <Card style={styles.cardTwo}>
              ...
              <Text style={{fontSize: 8, fontWeight: 'bold', textAlign: "center", padding: 2, margin: 5}} >Transactions</Text>
            </Card>
          </TouchableOpacity>
