     ...
     <Card style={{height: '45%'}}>
       ...
       <View style={styles.view}>
          <Card style={styles.cardTwo}>
            ...
            <Text style={{fontSize: 8, fontWeight: 'bold', textAlign: "center", padding: 0,}} >Scan QR</Text>
          </Card>
          <Card style={styles.cardTwo}>
            <Image source={require('../assets/images/browse-icons/transaction.png')} style={styles.imageTwo} />
            <Text style={{fontSize: 8, fontWeight: 'bold', textAlign: "center", padding: 0,}} >Transactions</Text>
          </Card>
          <Card style={styles.cardTwo}>
            <Image source={require('../assets/images/browse-icons/transfer.png')} style={styles.imageTwo} />
            <Text style={{fontSize: 8, fontWeight: 'bold', textAlign: "center", padding: 0,}} >Transfer</Text>
          </Card>
          <Card style={styles.cardTwo}>
            <Image source={require('../assets/images/browse-icons/wallet.png')} style={styles.imageTwo} />
            <Text style={{fontSize: 8, fontWeight: 'bold', textAlign: "center", padding: 0,}} >Fund Wallet</Text>
          </Card>
       </View>
     </Card>
   </View>
