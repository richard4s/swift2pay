...
export default class FundWallet extends Component {
  ...
  onSuccess(data) {
    ...
    fetch('http://swift2pay.com/account/api/request?action=walletFunding&apiKey=JFJHFJJ38388739949HFGDJ&userID=1&txref=VINC0.919548790537 https://swift2pay.com/account/api/request.php?action=profile&userID='+this.props.navigation.state.params.userId+'&apiKey=JFJHFJJ38388739949HFGDJ', {
      method: 'GET',
    }) 
