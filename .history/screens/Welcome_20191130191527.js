  ...
  render() {
    ...
    return (
      ...
      <View style={styles.screen}>
        ...
        <TouchableOpacity onPress={() =>navigate('Login')} style={styles.login} title='Login'><Text></Text></TouchableOpacity>
        <TouchableOpacity  title='SignUp' style={styles.signup}></TouchableOpacity>
